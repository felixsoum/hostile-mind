...
{
    class HospitalMainSpareRoom : Room
    {
        public HospitalMainSpareRoom()
        {
            ...
            builder.AddRoomTransition(typeof(HospitalMainHallway), currentPlan.Find("d0"), hallway.Find("d3").Top);
