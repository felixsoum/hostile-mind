...
{
    class Hospital5thFloorExplore3 : Room
    {
        public Hospital5thFloorExplore3()
        {
            ...
            builder.AddRoomTransition(typeof(Hospital5thFloorHallway), currentPlan.Find("d0"), hallway.Find("d3").Bottom);
