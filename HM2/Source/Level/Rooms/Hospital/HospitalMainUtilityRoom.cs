...
{
    class HospitalMainUtilityRoom : Room
    {
        public HospitalMainUtilityRoom()
        {
            ...
            builder.AddRoomTransition(typeof(HospitalMainHallway), currentPlan.Find("d0"), hallway.Find("d1").Top);
