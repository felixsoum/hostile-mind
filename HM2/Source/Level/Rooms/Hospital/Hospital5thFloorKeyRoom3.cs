...
{
    class Hospital5thFloorKeyRoom3 : Room
    {
        public Hospital5thFloorKeyRoom3()
        {
            ...
            builder.AddRoomTransition(typeof(Hospital5thFloorHallway), currentPlan.Find("d0"), hallway.Find("d8").Top);
