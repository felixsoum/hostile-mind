...
{
    public class MidComaSubwayCutscene : Cutscene
    {
        public override void Create(List<CutsceneAction> list)
        {
			...
			list.Add(new CutsceneDialogAction("Subway coma cutscene"));
			...
			list.Add(new CutsceneStateTransitionAction(new SubwayLevel()));
        }
    }
}
