...
{
	public class MidComaFinalCaseCutscene : Cutscene
    {
        public override void Create(List<CutsceneAction> list)
        {
			...
			list.Add(new CutsceneDialogAction("Final case coma cutscene"));
			...
			list.Add(new CutsceneStateTransitionAction(new FinalCaseLevel()));
        }
    }
}
